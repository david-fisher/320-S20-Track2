...
export const APPLICATIONS: Application[] = [
  ...
  {date: app2, name: 'Joseph Jones', supporter_type: 'Professional Staff', employer: 'Umass Amherst', team: 'Computer Science Department', title: 'Professor'},
  {date: app3, name: 'Katy Kellogg', supporter_type: 'Student Staff', employer: 'Umass Amherst', team: 'Cereal Department', title: 'Professor'}
];
